...
NETS_TO_DB = {
    ...
    "AMK MAYBANK CENTRE":                   "AMK Maybank",
    ...
    "KAKI BUKIT CAMP":                      None,  # 52920229 moved to NAB 2026-07-09
    ...
    "ONE NORTH MEDIACORP":                  None,  # 45021777 moved to Harbourfront Cruise Centre Departure 2026-07-17
